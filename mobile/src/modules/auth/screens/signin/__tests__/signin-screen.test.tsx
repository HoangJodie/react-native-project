...
jest.mock('../../../../../shared/components/Background', () => ({ children }: any) => <>{children}</>);
jest.mock('../../../../../shared/components/Button', () => (props: any) => <button onClick={props.onPress}>{props.children}</button>);
jest.mock('../../../useAuth', () => ({
    useAuth: jest.fn(),
}));
...
const useAuth = require('../../../useAuth').useAuth as jest.Mock;
